...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MasteryLogViewSet'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MasteryLogViewSet'));
  } else {
    // Browser globals (root is window)
    if (!root.KolibriApi) {
      root.KolibriApi = {};
    }
    root.KolibriApi.InlineResponse2006 = factory(root.KolibriApi.ApiClient, root.KolibriApi.MasteryLogViewSet);
  }
}(this, function(ApiClient, MasteryLogViewSet) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/MasteryLogViewSet>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results'))
        obj.results = ApiClient.convertToType(data['results'], [MasteryLogViewSet]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/MasteryLogViewSet>} results
   */
