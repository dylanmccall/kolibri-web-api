...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Buffer'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Buffer'));
  } else {
    // Browser globals (root is window)
    if (!root.KolibriApi) {
      root.KolibriApi = {};
    }
    root.KolibriApi.InlineResponse2007 = factory(root.KolibriApi.ApiClient, root.KolibriApi.Buffer);
  }
}(this, function(ApiClient, Buffer) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/Buffer>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results'))
        obj.results = ApiClient.convertToType(data['results'], [Buffer]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/Buffer>} results
   */
