...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KolibriApi.Role = factory(root.KolibriApi.ApiClient);
  }
   ...
   * @class
   * @param kind {module:model/Role.KindEnum} 
   * @param collection {String} 
   * @param user {String} 
   */
  var exports = function(kind, collection, user) {
    this.kind = kind;
  ...
  exports.KindEnum = {
    ...
    /**
     * value: "classroom assignable coach"
     * @const
     */
    classroomAssignableCoach: "classroom assignable coach"
  };
