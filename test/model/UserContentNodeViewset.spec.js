...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserContentNodeViewset', function() {
      beforeEach(function() {
        instance = new KolibriApi.UserContentNodeViewset();
      });

      it('should create an instance of UserContentNodeViewset', function() {
        // TODO: update the code to test UserContentNodeViewset
        expect(instance).to.be.a(KolibriApi.UserContentNodeViewset);
      });
