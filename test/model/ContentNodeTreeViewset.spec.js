...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ContentNodeTreeViewset', function() {
      beforeEach(function() {
        instance = new KolibriApi.ContentNodeTreeViewset();
      });

      it('should create an instance of ContentNodeTreeViewset', function() {
        // TODO: update the code to test ContentNodeTreeViewset
        expect(instance).to.be.a(KolibriApi.ContentNodeTreeViewset);
      });
